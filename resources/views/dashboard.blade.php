...
@section('content')
    ...
    <h1 class="text-center mb-4">Welcome, {{ Auth::user()->username }}</h1>
                ...
                <div class="row g-0 p-3">
                    ...
                    <div class="col-8">
                        <div class="card-body">
                            ...
                            <h6 class="card-text">{{ $book_count }}</h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0 p-3">
                    ...
                    <div class="col-8">
                        <div class="card-body">
                            ...
                            <h6 class="card-text">{{ $category_count }}</h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0 p-3">
                    ...
                    <div class="col-8">
                        <div class="card-body">
                            ...
                            <h6 class="card-text">{{ $user_count }}</h6>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <h1 class="mt-5 text-center">Loan Records</h1>
    <div class="card mt-3 shadow-lg border-light">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Loan Records Data Table</h5>
        </div>
